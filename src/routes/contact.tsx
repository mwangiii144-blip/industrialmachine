...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Coplex Industrial Machine | Nairobi Sewing Machine Shop" },
      {
        name: "description",
        content:
          "Call, WhatsApp, email or visit our Bujeki Building, Second Room Number 3 showroom in Nairobi for sewing machine sales, spare parts and repairs. Open Monday to Saturday.",
      },
      { property: "og:title", content: "Contact Coplex Industrial Machine | Nairobi Sewing Machine Shop" },
      {
          ...
          <div className="space-y-5">
            ...
            <Reveal delay={160}>
              <div className="card-surface overflow-hidden">
                <iframe
                  title="Coplex Industrial Machine location on Google Maps"
                  src={site.mapEmbed}
                  loading="lazy"
